...
// demchak_l2.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cdemchak_l2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание Cdemchak_l2App

Cdemchak_l2App::Cdemchak_l2App()
{
...
// Единственный объект Cdemchak_l2App

Cdemchak_l2App theApp;


// инициализация Cdemchak_l2App

BOOL Cdemchak_l2App::InitInstance()
{
