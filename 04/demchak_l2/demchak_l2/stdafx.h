...
void read(ifstream&, vector < unsigned char >& v);
void pcnt(vector < unsigned char >& v, vector < int >& v1);
int vmax(vector < int >& v);
unsigned char getkey(vector < int >& v, vector < int >& v1);
void decode(vector < unsigned char >& v, vector < unsigned char >& v1, string);
